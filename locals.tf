...
locals {
  ...
  revalidation_options = {
    ...
    enable_lambda_insights = coalesce(try(var.revalidation_options.enable_lambda_insights, null), false)
  ...
  warmer_options = {
    ...
    enable_lambda_insights = coalesce(try(var.warmer_options.enable_lambda_insights, null), false)
